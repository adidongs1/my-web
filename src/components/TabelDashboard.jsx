...
function TabelDashboard() {
    const { posts, fetchPosts, page, keyword, checked, setChecked, query, setQuery, setKeyword, setPage } = useContext(BlogContext)
                            ...
                            posts.length > 0 ? (
                                posts.map((post, index) => (
                                    ...
                                    <tr key={post.id} className={index % 2 === 0 ? 'bg-prim-jade-100' : ''}>
                                        ...
                                        {/* date */}
                                        <td>
                                            <span className='text-black text-base'>{new Date(post.date).toLocaleString('en-GB')} </span>
                                        </td>
                                        {/* title */}
                                        <td>
